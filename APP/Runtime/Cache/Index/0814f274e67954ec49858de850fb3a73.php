...
<body style="background-color: #eee">
	...
	<form action="" id="myform" method="post"style="margin-top:20px">
		...
		<div style=" margin: 0 auto;width: 94%;border-radius: 5px;">
			<div style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;padding: 10px 0 10px;border: 1px solid #ff9728;border-radius: 40px;box-sizing: border-box;width: 90%;height: 12vw;margin: 10px 1rem;padding: 10 5%;background: #fff;color: #ff9728;text-indent: 10px;outline: none;">
			...
			<div class="code" style="margin-left: 5%;width: 95%; height: auto;border-bottom: 1px solid #e3e3e3;padding: 10px 0 10px;border: 1px solid #ff9728;border-radius: 40px;box-sizing: border-box;width: 90%;height: 12vw;margin: 10px 1rem;padding: 10 5%;background: #fff;color: #ff9728;text-indent: 10px;outline: none;">
