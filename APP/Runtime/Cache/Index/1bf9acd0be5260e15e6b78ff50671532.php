...
<!--顶部开始-->
	...
	<span style="font-size:14px;text-align:center;color:red;margin-left:0%">温馨提示：&nbsp;&nbsp;&nbsp;支付宝账户名即为你支付宝实名认证的真实姓名，如果审核发现支付宝没有实名认证或者姓名不对应将无法通过认证！</span>
		  ...
		  <li>
            	<?php if(!empty($memmber['alipay_voucher']) and $memmber['checkstatus'] != 2): ?><img src="<?php echo ($memmber['alipay_voucher']); ?>" width="280" height="280" />
                <?php else: ?>
               <span class="sima1"><img src="<?php echo empty($memmber['cardpic'])? '/Public/gec/web/img/aa4.jpg': $memmber['alipay_voucher'];?>" onclick="document.getElementById('upfile').click()" id="clickimg" width="120" height="120"></span>
                ...
                <li style="margin-top: 5px;width:100%">&nbsp;&nbsp;&nbsp;</span></a></li>	
           ...
           <!--<li style="font-size:14px;">请上传身份证正面照片：&nbsp;&nbsp;&nbsp;</li>
            ...
            <li>
            <?php if(!empty($memmber['cardpic']) and $memmber['checkstatus'] != 2): ?><img src="<?php echo ($memmber['cardpic']); ?>" width="280" height="280" />
             ...
             <?php else: ?>
           			<span class="sima2">
                    	...
                    	<img src="<?php echo empty($memmber['cardpic'])? '/Public/gec/web/img/aa4.jpg': $memmber['cardpic'];?>" onclick="document.getElementById('upfile2').click()" id="clickimg2" width="120" height="120">
					                ...
					                <li style="margin-top: 5px;width:100%">&nbsp;&nbsp;&nbsp;</span></a></li>	
                 <span style="font-size:14px;text-align:center;color:red;margin-left:0%">查看参考：&nbsp;&nbsp;&nbsp;
                   </li><img src="/Public/gec/web/img/zzpz1.jpg" width="120" height="120" id="imgshow1"></span></li>
		...
		<?php if(!empty($memmber['liyou']) and $memmber['checkstatus'] == 2): ?><li style="height: 30px;line-height: 30px;margin-top: 5px;width:100%">审核结果：&nbsp;&nbsp;&nbsp;<font style="color:#F00;"><?php echo ($memmber['liyou']); ?></font></li>
       		<button type="submit" class="btn btn-primary btn-submit btn_submit" style="width: 100%;height: 30px;line-height: 30px;border-radius: 5px;border: 0px; background-color:#72ABE8;margin-top: 5px;color: #FFFFFF;-webkit-appearance: none;">提 交</button>
       
       <?php else: ?>
       	
            <?php if(empty($memmber['weixin']) || empty($memmber['truename'])): ?><button type="submit" class="btn btn-primary btn-submit btn_submit" style="width: 100%;height: 30px;line-height: 30px;border-radius: 5px;border: 0px; background-color:#72ABE8;margin-top: 5px;color: #FFFFFF;-webkit-appearance: none;">提 交</button><?php endif; endif; ?>	
...
<script type="text/javascript">
	$("#imgshow").click(function(){
			...
			layer.open({
			  ...
			  content: '<img src="/Public/gec/web/img/zzpz.jpg" width="100%" height="320">', //捕获的元素，注意：最好该指定的元素要存放在body最外层，否则可能被其它的相对元素所影响
...
<script type="text/javascript">
	$("#imgshow1").click(function(){
			...
			layer.open({
			  ...
			  content: '<img src="/Public/gec/web/img/zzpz1.jpg" width="100%" height="320">', //捕获的元素，注意：最好该指定的元素要存放在body最外层，否则可能被其它的相对元素所影响
