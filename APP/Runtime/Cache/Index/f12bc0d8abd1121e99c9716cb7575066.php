...
<div style=" width:100%; margin:10px auto; text-align:center;">
	...
	<a href="<?php echo U('Index/Financial/ksList',array('zt'=>1));?>" class='aall <?php if($zt == 1): ?>foncus<?php endif; ?>' style="margin-right:10px;">运行中云矿机</a>
    
    <a href="<?php echo U('Index/Financial/ksList',array('zt'=>2));?>" class='aall <?php if($zt == 2): ?>foncus<?php endif; ?>'>已过期云矿机</a>
...
<div class="zhul" style="padding-bottom:5px;margin-bottom:80px">
 ...
 <?php if(is_array($orders)): foreach($orders as $key=>$v): ?><tr style="text-align:center">
                ...
                <?php if($v['zt'] == 1): ?><a href="javascript:;"  <?php if($v['is_jiesuan'] == 0): ?>class="huibtn"<?php endif; ?> onClick="jiesuan(<?php echo ($v["id"]); ?>)" style="padding:3px 5px; background:#72ABE8; color:#FFFFFF; border-radius:4px;">结算收益</a>
                <?php else: ?>
                	---<?php endif; ?>
