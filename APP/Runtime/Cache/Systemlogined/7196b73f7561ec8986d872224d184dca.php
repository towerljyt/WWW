...
<script type="text/javascript">
	$(function() {
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addrole"  action="<?php echo U(GROUP_NAME .'/Rbac/addRoleHandle');?>" method="post">
		...
		<!--basic scripts-->
		<script type='text/javascript'>
			var checkRoleName = "<?php echo U(GROUP_NAME.'/Rbac/checkRoleName');?>";
		</script>
